<template lang="pug">
  v-card
    ...
    //-     div(id="viz" width="900px" height="700px" font="22pt arial" border="1px solid lightgray")
...
export default {
  ...
  methods: {
    draw() {
      ...
      var links = [
        { target: "mammal", source: "dog" , strength: 1.7 },
        { target: "mammal", source: "cat" , strength: 1.7 },
